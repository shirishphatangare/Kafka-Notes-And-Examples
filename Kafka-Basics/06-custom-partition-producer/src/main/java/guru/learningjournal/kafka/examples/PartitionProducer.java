...
/*
    By default, Kafka partitioning algorithm is based on message Key. However, in some scenarios we may want to change default behavior and
    implement custom partitioning algorithm.
 */
