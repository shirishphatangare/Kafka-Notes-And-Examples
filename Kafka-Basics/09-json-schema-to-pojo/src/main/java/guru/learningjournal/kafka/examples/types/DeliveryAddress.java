...
/* This is one of the 4 generated POJO class from JSON Schemas
*  We use Json Schema to POJO plugin (jsonschema2pojo) defined in pom.xml
*  Just maven-compile this project and POJOs will be generated
*/
...
public class DeliveryAddress {
    // Jackson annotations make this class Serializable/de-serializable
